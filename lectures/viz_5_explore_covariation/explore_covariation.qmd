...
Exponential and dispersed. Ceiling is at 19k. 
...
Take a continuous variable, bin, and then create a boxplot. Not as useful in this context. Could increase the whiskers, or plot a random subsample to give reader a sense of the outliers. 

Spread is bigger in the middle versus at the ends (as seen in the interquartile range). Lots of outliers at 1.5. Medians go up and then dip back down (at 2.5-3). 

Have no sense of the count of the records. 
